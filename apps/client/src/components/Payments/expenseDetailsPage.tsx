import { Box, Button, Container, Flex, Heading, Input, NumberInput, Stack, Text } from '@chakra-ui/react';
    ...
    <Container maxW="lg" py={8}>
      <Stack gap={6}>
        <Heading size="lg" textAlign="center">
          {expenseId ? t('payments.expense.edit_expense') : t('payments.expense.create_expense')}
        </Heading>
          ...
          <Stack gap={4}>
            <Box>
              <Text mb={1} fontWeight="medium">
                {t('payments.expense.expense_description')}
              </Text>
              <Input
                placeholder={t('payments.expense.expense_description')}
            ...
            <Box>
              <Text mb={1} fontWeight="medium">
                {t('payments.expense.expense_amount')}
              </Text>
            ...
            <Flex alignItems="center" gap={2} flexWrap="wrap">
              <Text>{t('payments.expense.paid_by')}</Text>
              <SelectUserDrawer
                onSelect={setPaidBy}
                trigger={
              ...
              />
              <Text>{t('payments.expense.and_splits')}</Text>
              <SplitDetailsDrawer
                trigger={
                  <Button size="sm" px={1} py={0} h="unset" variant={'surface'}>
