...
export const ApartmentInfo = ({ aptDetails, updateField, isEdit }: CommonApartmentProps<'apartmentInfo'> & { isEdit: boolean }) => {
  ...
  const roles = useMemo(
    () => [
      {
        value: UserRole.ROOMMATE,
        title: t('create_apartment.apartment_info.who_am_i.renter'),
        image: '/detailed_icons/renter.png',
      },
      {
        value: UserRole.LANDLORD,
        title: t('create_apartment.apartment_info.who_am_i.leaser'),
        image: '/detailed_icons/leaser.png',
      },
    ],
    [t]
  );
