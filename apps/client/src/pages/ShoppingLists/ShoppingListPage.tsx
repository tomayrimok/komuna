import { Box, Button, Card, Drawer, Flex, Icon, IconButton, Input, Loader, Text } from '@chakra-ui/react';
...
const ShoppingListPage: React.FC = () => {
  ...
  const { items, newItem, updateOrder, handleAddItem, openEditDrawer, isShoppingListLoading } = useShoppingList();
