...
export class ApartmentController {
  ...
  @Post()
  @UseAuth()
  createApartment(@Body() createApartmentData: CreateApartmentDto, @GetUser() user: User) {
    console.log("In createApartment");
    console.log('createApartmentData: ', createApartmentData);
