...
export type Apartment = {
  ...
  name: string;
  /**
   * URL to apartment image
   */
  image?: string;
  /**
   * Unique code for the apartment
   */
  code: string;
  /**
   * Apartment address
  ...
  city?: string;
  /**
   * ID of the apartment manager
   */
  managerId?: string;
  /**
   * Apartment contract details
   */
  contract?: string;
  /**
  ...
  /**
   * Apartment shopping templates
   */
  shoppingTemplates: Array<ShoppingTemplate>;
  /**
   * Apartment shopping lists
   */
  shoppingLists: Array<ShoppingList>;
  /**
   * Date when the apartment was created
   */
  createdAt: string;
};
